...
- [DHTMLX/gantt](https://github.com/DHTMLX/gantt) - JavaScript Gantt Chart
...
- [leotm/react-native-template-new-architecture](https://github.com/leotm/react-native-template-new-architecture) - React Native 0.88 ⚡ Hardened JS 🔒 LavaMoat 🌋 Ubuntu 26 🐧 Xcode 27 🍎 Hermes V1 ⚙️ Fiber / Fabric / Yoga 🏎️  Turbo / Nitro 💨 TS 7 ✅ Kotlin 2.2, JDK 25, NDK 27 🤖 Ruby 3.4 💎 Yarn 4 📦 ESLint 🧹 Prettier ✨ Babel 🗼 Hardened GHA + deps 🔒 Storybook 10 🚧 Node 22 ⬢ Buck2 🚧 Renovate 🛠️ Socket ⚡ for curious early adopters :suspect: #RNEU #APPJS
...
- [swisspost/design-system](https://github.com/swisspost/design-system) - Patterns, components and guidance for a consistent and inclusive user experience across the web platform.
...
- [google-gemini/jot-gemini-transcribe-macOS](https://github.com/google-gemini/jot-gemini-transcribe-macOS) - Gemini 3.5 Transcribe demo. Hold a key. Speak. It types. Smart dictation for macOS.
...
- [Lemick/open-iframe-resizer](https://github.com/Lemick/open-iframe-resizer) - Open-source modern iframe resizer
